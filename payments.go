...
type TransactionPartnerFragment struct {
	...
	WithdrawalState interface{} `json:"withdrawal_state"` // RevenueWithdrawalStatePending | RevenueWithdrawalStateSucceeded | RevenueWithdrawalStateFailed
}
...
type StarTransaction struct {
	...
	Amount   int         `json:"amount"`
	Date     int         `json:"date"`
	Source   interface{} `json:"source"`   // TransactionPartnerFragment | TransactionPartnerUser | TransactionPartnerOther
	Receiver interface{} `json:"receiver"` // TransactionPartnerFragment | TransactionPartnerUser | TransactionPartnerOther
}
...
func (b *Bot) GetStarTransactions(offset int, limit int) (*StarTransactions, error) {
